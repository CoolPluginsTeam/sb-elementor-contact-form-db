...
if (!class_exists('fdbgp_cronjob')) {
    class fdbgp_cronjob
    {
        ...
        public function __construct()
        {
            ...
            add_filter('cron_schedules', array($this, 'fdbgp_cron_schedules'));
            add_action('fdbgp_extra_data_update', array($this, 'fdbgp_cron_extra_data_autoupdater'));
        }
        ...
        public function fdbgp_cron_schedules($schedules)
        {
         ...
         */ 
         ...
         static public function fdbgp_send_data() {
 
                 $feedback_url = FDBGP_FEEDBACK_URL.'wp-json/coolplugins-feedback/v1/site';
                 ...
                 $extra_data_details = static::cpfm_get_user_info();
                  ...
                  $initial_version = get_option('formsdb_initial_version');
                  $initial_version = is_string($initial_version) ? sanitize_text_field($initial_version) : 'N/A';
                  $plugin_version = defined('FDBGP_PLUGIN_VERSION') ? FDBGP_PLUGIN_VERSION : 'N/A';
