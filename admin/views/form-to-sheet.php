        ...
        ?>
            <div class="fdbgp-card cfk-left">
                ...
                <div class="fdbgp-help-box">
                    <h4>NEED HELP?</h4>
                    <ul>
                    <li><a href="https://docs.coolplugins.net/doc/formsdb-video-tutorials/?utm_source=fdbgp_plugin&utm_medium=inside&utm_campaign=docs&utm_content=setting_page_sidebar#how-to-save-elementor-form-submissions-to-google-sheets" target="_blank" rel="noopener noreferrer">▶ Watch Video Tutorial</a></li>
                    <li><a href="https://docs.coolplugins.net/doc/sync-form-submissions-google-sheets/?utm_source=fdbgp_plugin&utm_medium=inside&utm_campaign=docs&utm_content=setting_page_sidebar#how-to-save-elementor-form-submissions-to-google-sheets" target="_blank" rel="noopener noreferrer">📄 Read Documentation</a></li>
