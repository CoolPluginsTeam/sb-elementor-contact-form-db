...
**[FormsDB](https://coolformkit.com/formsdb-elementor-forms-submissions-google-sheets/?utm_source=formsdb&utm_medium=readme&utm_campaign=plugin_page&utm_content=top_name)** is a useful addon for **Elementor Forms** that lets you connect Elementor forms with Google Sheets to sync form entries or save form submissions into any WordPress post type.
...
> **Important Notice**: From version **2.0.0**, this plugin has been acquired, fully rebuilt, and rebranded as **FormsDB** by **[Cool Plugins](https://coolplugins.net/?utm_source=formsdb&utm_medium=readme&utm_campaign=home&utm_content=notice)**. It has been redesigned with new features like Google Sheets sync and frontend post submission, as its earlier functionality is now available within Elementor Pro. If you were using older versions, you can export previous entries from the **FormsDB → Old Submissions** tab.

### FormsDB Plugin Features

* **[Sync Elementor Forms with Google Sheets](http://docs.coolplugins.net/doc/sync-form-submissions-google-sheets/?utm_source=formsdb&utm_medium=readme&utm_campaign=docs&utm_content=features)**  
...
* **[Send Form Submissions to Post Type](http://docs.coolplugins.net/doc/save-form-submissions-post-type/?utm_source=formsdb&utm_medium=readme&utm_campaign=docs&utm_content=features)**  
...
* **[Conditional Fields for Elementor Form](https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=get_pro&utm_content=form_addons)**  
Add conditional logic to Elementor form fields and dynamically show or hide inputs based on user choices. This helps create cleaner forms and improves the overall user experience.

* **[Country Code for Elementor Form Telephone Field](https://wordpress.org/plugins/country-code-field-for-elementor-form/)**  
Add a country code dropdown to phone fields so users can easily select their country while entering mobile numbers, ensuring accurate and properly formatted submissions.

* **[Cool FormKit](https://coolformkit.com/?utm_source=formsdb&utm_medium=readme&utm_campaign=get_pro&utm_content=form_addons)**  
Cool FormKit is a complete form builder for Elementor Free and Pro. It extends Elementor Pro forms with advanced fields and also provides a dedicated form builder for Elementor Free users. Popular features include:  
  * **[Conditional Logic](https://coolformkit.com/features/conditional-logic-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  
  * **[Range Slider Field](https://coolformkit.com/features/range-slider-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  
  * **[Signature Field](https://coolformkit.com/features/signature-field-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  
  * **[Select2 Field](https://coolformkit.com/features/select2-field-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  
  * **[Image Radio & Checkbox Fields](https://coolformkit.com/features/image-radio-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  
  * **[Rating Field](https://coolformkit.com/features/rating-field-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  
  * **[Calculator Field](https://coolformkit.com/features/calculator-for-elementor/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  
  * **[Cloudflare Turnstile](https://coolformkit.com/features/cloudflare-turnstile-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  
  * **[hCAPTCHA Support](https://coolformkit.com/features/hcaptcha-for-elementor-form/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**  

👉 **[View all Cool FormKit features](https://coolformkit.com/features/?utm_source=formsdb&utm_medium=readme&utm_campaign=features&utm_content=form_addons)**
...
Enhance Elementor Pro Loop Grids by adding support for ACF Repeater fields and advanced taxonomy-based filtering options.

* **[AutoPoly - AI Translation for Polylang](https://coolplugins.net/product/autopoly-ai-translation-for-polylang/?utm_source=formsdb&utm_medium=readme&utm_campaign=get_pro&utm_content=other_addons)**  
Automatically translate Elementor pages using AI and build multilingual websites faster with Polylang integration.

* **[Timeline Widget for Elementor](https://cooltimeline.com/plugin/timeline-widget-pro/?utm_source=formsdb&utm_medium=readme&utm_campaign=get_pro&utm_content=other_addons)**  
Create visually engaging vertical or horizontal timelines to display company history, milestones, roadmaps, or events inside Elementor pages.

* **[Events Widgets for Elementor](https://eventscalendaraddons.com/plugin/events-widgets-pro/?utm_source=formsdb&utm_medium=readme&utm_campaign=get_pro&utm_content=other_addons)**  
Easily add The Events Calendar widgets to Elementor and display events in grid, list, or carousel layouts.
...
2. Google Sheets API Settings
3. Save Elementor Form Submissions to Post Type
4. Hello Plus Form Entries
5. FormsDB Dashboard – Forms to Google Sheets
...
👉 Learn more: **[Sync Elementor Forms with Google Sheets](http://docs.coolplugins.net/doc/sync-form-submissions-google-sheets/?utm_source=formsdb&utm_medium=readme&utm_campaign=docs&utm_content=faqs)**
...
👉 Learn more: **[Send Form Submissions to Post Type](http://docs.coolplugins.net/doc/save-form-submissions-post-type/?utm_source=formsdb&utm_medium=readme&utm_campaign=docs&utm_content=faqs)**
...
👉 https://wordpress.org/support/plugin/sb-elementor-contact-form-db/

Cool Plugins also develops popular Elementor form addons like **[Cool FormKit](https://coolformkit.com/?utm_source=formsdb&utm_medium=readme&utm_campaign=get_pro&utm_content=faqs)** (20,000+ active installs) and **[Conditional Fields](https://wordpress.org/plugins/conditional-fields-for-elementor-form/)** (10,000+ active installs), so you are using a plugin maintained by an experienced team focused on Elementor form solutions.
...
👉 [Sync Elementor Form with Google Sheets](http://docs.coolplugins.net/doc/sync-form-submissions-google-sheets/?utm_source=formsdb&utm_medium=readme&utm_campaign=docs&utm_content=installation)
...
👉 [Save Elementor Form Submissions to Post Type](http://docs.coolplugins.net/doc/save-form-submissions-post-type/?utm_source=formsdb&utm_medium=readme&utm_campaign=docs&utm_content=installation)
