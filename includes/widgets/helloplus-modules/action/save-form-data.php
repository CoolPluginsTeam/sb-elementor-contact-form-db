...
class Save_Form_Data {
    ...
    public function add_controls($element, $args) {
        $element->add_control(
            'save_form_data',
            [
                'label' => esc_html__('Save Form Data', 'sb-elementor-contact-form-db'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'sb-elementor-contact-form-db'),
                'label_off' => esc_html__('No', 'sb-elementor-contact-form-db'),
                'default' => 'yes',
                'description' => esc_html__('Choose whether to save the form data or not', 'sb-elementor-contact-form-db'),
            ]
        );
        $element->add_control(
